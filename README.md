...
1. User logs into the application using a mobile number and OTP verification.
2. The dashboard provides two options:

   * Scan QR code
   * Upload QR image
3. The system extracts payment details from the QR code.
4. The user confirms the merchant and payment details.
5. The fraud detection engine evaluates the transaction risk.
6. Based on the risk score, the system provides one of three outcomes:
